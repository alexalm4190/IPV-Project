...
base_data_dir='C:\Users\Alexandre\Documents\Alexandre\IST\PIV\Datasets\Maizena';
d1=dir([base_data_dir 'depth_1*']);
d2=dir([base_data_dir 'depth_2*']);
r1=dir([base_data_dir 'rgb_image_1*']);
r2=dir([base_data_dir 'rgb_image_2*']);
for i=1:length(d1),
